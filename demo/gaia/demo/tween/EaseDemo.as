package gaia.demo.tween
{
	...
	public class EaseDemo extends Sprite
	{
		...
		private function createButtons():void
		{
			...
			vos.push(new GraphVO(Cubic.easeIn, "Cubic.easeIn", 0x99EE00));
			vos.push(new GraphVO(Cubic.easeOut, "Cubic.easeOut", 0x99EE00));
			vos.push(new GraphVO(Cubic.easeInOut, "Cubic.easeInOut", 0x99EE00));
